import FlabbergastedActorBase from "./base-actor.mjs";
...
export default class FlabbergastedCharacter extends FlabbergastedActorBase {
  ...
  static defineSchema() {
    ...
    schema.abilities = new fields.SchemaField(Object.keys(CONFIG.FLABBERGASTED.abilities).reduce((obj, ability) => {
